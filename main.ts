...
multigame.onLifeZero("game", function () {
    game.setGameOverMessage(false, "No conseguiste llegar")
    game.gameOver(false)
    game.setGameOverEffect(false, effects.dissolve)
})
multigame.onUpdateInterval("game", randint(100, 2000), function () {
    if (initGame) {
...
multigame.onStart("ending", function () {
    story.startCutscene(function () {
        ...
        tioVila = sprites.create(img`
            ...
            ..............................
            `, SpriteKind.Player)
        tioVila.setPosition(15, 90)
        story.spriteSayText(tioVila, "No puedo más")
        encanta2 = sprites.create(img`
            ...
            ................
            `, SpriteKind.Player)
        encanta2.setPosition(55, 60)
        encanta2.ay = 200
        story.spriteSayText(encanta2, "Te maldigo a morir con la lengua fuera")
        pause(2000)
        IrFase("ending", "final")
    })
})
...
multigame.onStart("game", function () {
    ...
    tioVila.setPosition(15, 90)
    tioVila.ay = aceleracionSalto
    story.spriteSayText(tioVila, "Te llevaré al rio")
    pause(1000)
    initGame = true
})
function RandomizeImage (background: Image) {
    ...
    for (let index = 0; index <= 14; index++) {
        temp.replace(index, randint(0, 14))
    }
...
multigame.A.onEvent("game", ControllerButtonEvent.Pressed, function () {
    if (tioVila.isHittingTile(CollisionDirection.Bottom)) {
        tioVila.vy = velocidadSalto
    }
})
